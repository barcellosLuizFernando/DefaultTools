...
public class BuscaCNPJ {
    ...
    public Empresa buscaEmpresa(String inscricao) throws Exception {
    ...
    private void buscaDados(String inscricao) throws Exception {
        ...
        try {
            ...
            throw new Exception("Erro ao Buscar CNPJ: " + cnpj + ".\nTente novamente em alguns minutos.");
